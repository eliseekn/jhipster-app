...
export const ItemsUpdate = (props: IItemsUpdateProps) => {
  const [isNew, setIsNew] = useState(!props.match.params || !props.match.params.id);

  const { itemsEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="todoApp.items.home.createOrEditLabel">Create or edit a Items</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : itemsEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="items-description">
                  Description
                </Label>
                <AvField
              ...
              <Button tag={Link} id="cancel-save" to="/items" replace color="info">
...
export default connect(mapStateToProps, mapDispatchToProps)(ItemsUpdate);
